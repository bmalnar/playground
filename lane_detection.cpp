...
cv::Mat pipeline(cv::Mat in) {
    ...
    cv::convertScaleAbs(sobel_l_x / 256, scaled_sobel_l_x);
...
int main() {
    ...
    cout << exists("in_video.mp4") << endl;
    cout << exists("in_image.jpg") << endl;
    ...
    while (1) {
        ...
        Mat undist, undist_warped, undist_warped_bgr;
